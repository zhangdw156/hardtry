...
# 与 verl_meta_config.checkpoint_dir / merged_model_path 一致，使用相同占位符
CHECKPOINT_BASE="/dfs/data/work/hardtry/checkpoints/verl22"
TARGET_DIR="/dfs/data/models/hardtry-4b-verl22"
