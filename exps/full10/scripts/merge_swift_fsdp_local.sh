...
# BASE_MODEL_PATH 与训练一致：从 configs/sft_config.yaml 的 model 读取。
...
CHECKPOINT_BASE="/dfs/data/work/hardtry/checkpoints/full10"
TARGET_DIR="/dfs/data/models/hardtry-4b-full10"
